...
export const DraggableCardWorkoutSheet = ({
	...
	return (
		...
		>
			{(provided, _) => (
				<div
					className='flex items-center justify-between w-full px-2 mb-3 transition-shadow duration-500 bg-white rounded-md shadow-md sm:px-4 hover:shadow-xl sm:text-sm'
